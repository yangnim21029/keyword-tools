...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      colors: { // 使用 Apple 风格颜色定义 shadcn/ui 语义颜色
      ...
      borderRadius: { // shadcn/ui 圆角配置
        lg: "var(--radius)",
        md: "calc(var(--radius) - 2px)",
        sm: "calc(var(--radius) - 4px)",
      },
      keyframes: { // shadcn/ui 动画配置
        "accordion-down": {
          from: { height: "0" },
