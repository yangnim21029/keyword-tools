    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          {mounted ? (
            <>
              <Sun className={`h-[1.1rem] w-[1.1rem] text-amber-500 transition-all duration-300 ease-in-out ${
                isDarkMode ? 'opacity-0 scale-0' : 'opacity-100 scale-100'
              }`} />
              <Moon className={`absolute h-[1.1rem] w-[1.1rem] text-blue-400 transition-all duration-300 ease-in-out ${
      ...
      <DropdownMenuContent align="end" className={`border rounded-lg ${
        ...
        >
          ...
          <span className={theme === 'light' ? 'font-medium' : ''}>淺色模式</span>
          {theme === 'light' && (
        ...
        >
          ...
          <span className={theme === 'dark' ? 'font-medium' : ''}>深色模式</span>
          {theme === 'dark' && (
            <span className="ml-auto text-blue-500">✓</span>
          )}
        </DropdownMenuItem>
        ...
        >
          ...
          <span className={theme === 'system' ? 'font-medium' : ''}>系統設定</span>
          {theme === 'system' && (
            <span className="ml-auto text-blue-500">✓</span>
          )}
        </DropdownMenuItem>
