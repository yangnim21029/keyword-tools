            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Select value={region} onValueChange={setRegion}>
                  <SelectTrigger
                    id="settings-region"
                    className="w-full border border-gray-300 bg-white text-gray-900 focus:ring-1 focus:ring-blue-500 data-[placeholder]:text-gray-500"
                  >
          ...
          <div className="border-t border-gray-200 pt-4">
            ...
            <div className="space-y-2 pt-4">
              <div className="flex justify-between items-center">
                <div>
                  <Label htmlFor="max-results" className="font-medium">
                    最大結果數
                  </Label>
                ...
                <span className="text-sm text-gray-600 bg-blue-50 px-2 py-0.5 rounded-full">
                  {maxResults} 個關鍵詞
                </span>
              </div>
              <Input
