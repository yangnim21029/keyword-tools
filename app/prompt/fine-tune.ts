...
export const THEME_FINE_TUNE_DATA = [
  {
    ...
    data_set_description:
      "這個資料集是針對食譜文章的優化，主要針對食譜文章的結構進行優化，包括食譜的結構、食譜的內容、食譜的格式等。",
    data: [
      {
        Bad: "延伸推薦：更多食譜推介",
        Good: "食譜A+食譜B+食譜C",
      ...
      },
      {
        ...
        Reason: "",
        Guide:
          "譬如「烹煮重點（在『製作步驟』已經有提及」、「保存方法（在『常見問題』中已經有提及」。另外，在「飲用建議與其他湯品比較」也與以上一些內容出現重覆，所以我也會把這一部分與上面重覆的內容結合）",
        ErrorType: "",
        Process: "",
        Section: "食譜",
        From: "南瓜栗子湯功效",
      },
      {
        ...
        Reason: "",
        Guide:
          "這篇文章主要是針對「南瓜栗子湯」，並不太適合出現其他湯品的介紹。",
        ErrorType: "",
        Process: "",
        Section: "食譜清單",
        From: "南瓜栗子湯功效",
      ...
      },
      {
        ...
        Good: "",
        Reason:
          "讀者可能比較關心這道湯品的整體功效，並較少關注在於食品單獨的功效。",
        Guide: "",
        ErrorType: "",
        Process: "",
        Section: "功效",
      ...
      },
      {
        ...
        Reason: "",
        Guide:
          "例如先以「南瓜栗子湯」為大題展開，並延伸至「南瓜栗子淮山湯」與「南瓜栗子排骨湯」的食譜進行，以此類推。",
        ErrorType: "",
        Process: "",
        Section: "食譜清單",
        From: "南瓜栗子湯功效",
      ...
      },
      {
        ...
        Reason: "",
        Guide:
          "食材的種植方式與來源是否道德生產和環境友好，只留跟主題特別相關的部分，需要增加吸引力",
        ErrorType: "",
        Process: "",
        Section: "文化",
        From: "合掌瓜淮山栗子湯",
      ...
      },
      {
        ...
        Reason: "",
        Guide:
          "「多種變化版本」只是簡單介紹，如果加入詳細多種菜譜會讓文章更充足",
        ErrorType: "",
        Process: "",
        Section: "食譜清單",
        From: "豆腐魚湯食譜",
      ...
      },
      {
        ...
        Reason: "",
        Guide:
          "「提升免疫力的配方指南」與「健康功效」相似，而且這個部分資訊冗長。（刪減）\n",
        ErrorType: "",
        Process: "",
        Section: "功效",
        From: "豆腐魚湯食譜",
      ...
      },
      {
        ...
        Reason: "",
        Guide:
          "H2擬題命名有點模糊。例如 「特定健康功效」修改成「湯品健康功效」會更清晰。",
        ErrorType: "SEO錯誤",
        Process: "修正",
        Section: "大綱",
        From: "豆腐魚湯食譜",
...
export const MEDIA_SITE_FINE_TUNE_DATA = [
  {
    ...
    date: "2025-04-18",
    data_set_description:
      "這個資料集是針對都市生活文章的優化，主要針對都市生活文章的結構進行優化，包括都市生活文章的結構、都市生活文章的內容、都市生活文章的格式等。",
    data: [
      {
        Guide: "標題提到關鍵字，要【】",
      },
...
export const LANGUAGE_FINE_TUNE_DATA = [
  {
    ...
    date: "2025-04-18",
    data_set_description:
      "這個資料集是針對中文繁體的錯字進行優化，主要針對中文繁體的錯字進行優化，包括中文繁體的錯字、中文繁體的錯字、中文繁體的錯字等。",
    data: [
      {
        Error: "薏苡仁",
        Correct: "薏米",
  ...
  },
  {
    ...
    date: "2025-04-18",
    data_set_description:
      "這個資料集是針對香港繁體的錯字進行優化，主要針對香港繁體的錯字進行優化，包括香港繁體的錯字、香港繁體的錯字、香港繁體的錯字等。",
    data: [
      {
        HK: "粟玉",
        TW: "玉米",
