...
// 删除搜索历史记录
export async function deleteKeywordResearchHistory(historyId: string) {
  'use server';
  try {
...
export async function getKeywordResearchHistoryDetailInternal(historyId: string) {
    'use server';
    try {
...
export async function updateKeywordResearchHistoryWithResults(
  ...
  'use server';
  try {
    // Use the specific Firebase update function (using the correct import name)
